...
"[project]/app/api/geral/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        const raw = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$csv$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchAba"])("geral");
        const dados = raw.map(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizaGeral"]).filter((d)=>d.edicao);
        const regioesDisponiveis = Array.from(new Set(dados.map((d)=>d.regiao))).sort((a, b)=>a === "BR" ? -1 : b === "BR" ? 1 : a.localeCompare(b));
        const edicoesDisponiveis = Array.from(new Set(dados.map((d)=>d.edicao))).sort();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1phbzvz._.js.map